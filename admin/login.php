...
<div class="row"><h2>Team Knightryders  Login</h2>
<h4 class="bg-danger"><?php echo $the_message; ?></h4></div>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="" method="post">
    ...
    <div class="container">
      ...
      <input type="text" value="<?php echo htmlentities($username); ?>" name="username" required>

      <label for="password"><b>Password</b></label>
      <input type="password" value="<?php echo htmlentities($password); ?>" name="password" required>
